...
<div class="row">
    ...
    <div class="col-md-3 mb-4">
        <div class="card d-inline-flex mainMenu" style="width: 100%; padding: 12px; border-left: 5px solid indigo; margin-bottom: 20px;">
            <a href="{{ route('hrd.manajer') }}" style="text-decoration: none; color: black;">
                <div class="d-flex">
                    <div style="width: 100%;">
                        <h6 style="color: indigo;">Jumlah Manajer Divisi</h6>
                        <h4>{{ $manajer }}</h4>
                    </div>
    ...
    <div class="col-md-3 mb-4">
        <div class="card d-inline-flex mainMenu" style="width: 100%; padding: 12px; border-left: 5px solid #1746a2; margin-bottom: 20px;">
            <a href="{{ route('hrd.karyawan') }}" style="text-decoration: none; color: black;">
                <div class="d-flex">
                    <div style="width: 100%;">
