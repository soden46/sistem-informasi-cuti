                ...
                <div class="card-body">
                    <form action="{{ route('hrd.cuti.update', $cuti->no_cuti) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_cuti" class="form-control" value="{{ $cuti->no_cuti }}" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_jenis_cuti" class="form-control" required>
                                ...
                                <option value="{{ $jenis->id }}" {{ $cuti->id_jenis_cuti == $jenis->id ? 'selected' : '' }}>
                                    {{ $jenis->nama_cuti }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="stt_cuti" class="form-control" required>
                                <option value="Pending" {{ $cuti->stt_cuti == 'Pending' ? 'selected' : '' }}>Pending</option>
                                <option value="Approved" {{ $cuti->stt_cuti == 'Approved' ? 'selected' : '' }}>Approved</option>
                                <option value="Rejected" {{ $cuti->stt_cuti == 'Rejected' ? 'selected' : '' }}>Rejected</option>
                            </select>
                        </div>
                        <div class="form-group">
