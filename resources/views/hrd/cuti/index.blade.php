...
<table class="table table-bordered table-responsive">
    ...
    <tr>
        ...
        <td style="width: 150px">{{Date('d/m/Y',$data->tgl_pengajuan ?? '')}}</td>
        <td style="width: 150px">{{Date('d/m/Y',$data->tgl_awal ?? '')}}</td>
        <td style="width: 150px">{{Date('d/m/Y',$data->tgl_akhir ?? '')}}</td>
