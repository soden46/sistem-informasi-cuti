...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-3">
        <div>
            <form action="{{ route('hrd.karyawan') }}" method="GET" class="d-flex">
        ...
        <div>
            ...
            <a class="btn btn-md btn-success" href="{{ route('hrd.karyawan.cetak') }}" target="_blank"><i
    ...
    <table class="table table-bordered table-responsive">
        ...
        @foreach ($karyawan as $data)
            <tr>
                ...
                <td style="width: 150px">{{ asset('storage/', $data->foto_emp) }}</td>
