...
<body class="text-center">
    ...
    <main class="form-signin w-100 m-auto">
        ...
        <form action="/authenticate" method="POST">
            ...
            <p class="text-muted" style="font-size: 12px; margin-top: -8px;">Silakan masukan Nama dan Password anda</p>

            <div class="form-group">
                <input style="height: 55px" type="text" class="form-control" id="nama_emp" name="nama_emp" placeholder="Nama" autocomplete="off">
            </div>
